...
plt.plot(ConstantsWilson.x1_Willson, modelEqns.Wilson_GibbsEx(), label="GM_Wilson")
...
plt.plot(ConstantsWilson.x1_Willson, modelEqns.Model_Bubble(
    ConstantsWilson.x1_Willson[1:ConstantsWilson.end-1], ConstantsWilson.x2_Willson [1:ConstantsWilson.end-1], modelEqns.Calculation_Gamma(
        ConstantsWilson.x1_Willson, ConstantsWilson.x2_Willson , modelEqns.Wilson_Constants()[0], modelEqns.Wilson_Constants()[1])[0][1:11], modelEqns.Calculation_Gamma(
